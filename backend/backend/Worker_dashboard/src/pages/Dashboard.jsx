...
const consumeItem = async (item, qty) => {
  ...
  try {
    ...
    const response = await axios.post(
      window.API_BASE + "/api/inventory/consume",
      {
        inventoryId: item.id,
        quantity: qty,
      }
  ...
  const watchId = navigator.geolocation.watchPosition(
    ...
    async (position) => {
      ...
      try {
        ...
        await fetch(
          window.API_BASE + "/api/location/worker/update",
          {
            method: "POST",
...
const fetchDashboardData = async () => {
  try {
    ...
    const attendanceRes = await axios.get(
      window.API_BASE + "/api/attendance",
      config
    );
    ...
    const inventoryRes = await axios.get(
      window.API_BASE + "/api/inventory",
      config
    );

    //Inventory History
const historyRes = await axios.get(
  window.API_BASE + "/api/inventory/history"
);
