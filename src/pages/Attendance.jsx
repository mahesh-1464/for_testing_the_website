...
try {
  const url =
    captureType === "IN"
      ? `http://localhost:8000/api/attendance/${selectedRecord.id}/check-in-photo`
      : `http://localhost:8000/api/attendance/${selectedRecord.id}/check-out-photo`;
...
src={
  selectedRecord.inPhoto?.startsWith("data:")
    ? selectedRecord.inPhoto
    : `http://localhost:8000/${selectedRecord.inPhoto}`
}                      alt="IN"
                      sx={{
                        width: "100%",
                        maxHeight: 220,
...
src={
  selectedRecord.outPhoto?.startsWith("data:")
    ? selectedRecord.outPhoto
    : `http://localhost:8000/${selectedRecord.outPhoto}`
}
                      alt="OUT"
                      sx={{
                        width: "100%",
